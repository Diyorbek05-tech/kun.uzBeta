    ...
    <div className="mx-15 py-4">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 mb-6">
        <div className="lg:col-span-8">
          {featuredPost && (
            <div className="bg-white rounded overflow-hidden shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
              ...
              <div className="p-5">
                ...
                <h1 className="text-2xl font-bold text-gray-900 mb-3 leading-tight hover:text-blue-600 transition-colors cursor-pointer">
                  {featuredPost.title}
                </h1>
          ...
          <div className="bg-white rounded shadow-sm border border-gray-200 p-4">
            <div className="space-y-4">
              {sidebarNews.map((post, idx) => (
                <div
                  key={post.id}
                  className="flex gap-3 pb-4 border-b border-gray-200 last:border-0 last:pb-0 hover:opacity-80 transition-opacity cursor-pointer"
                >
        ...
        <div className="lg:col-span-7">
          <div className="space-y-3">
            {posts.slice(22, 28).map((post) => (
              <div
                key={post.id}
                className="bg-white rounded overflow-hidden shadow-sm border border-gray-200 hover:shadow-md transition-shadow"
              >
                <div className="flex gap-3 p-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <h3 className="text-sm font-semibold text-gray-900 mb-1.5 line-clamp-2 leading-snug hover:text-blue-600 transition-colors cursor-pointer">
                      {post.title}
                    </h3>
            ...
            <div className="space-y-3 max-h-[600px] overflow-y-auto">
              {editorChoice.map((post) => (
                <div key={post.id} className="border-b border-gray-200 pb-3 last:border-0">
                  ...
                  <h3 className="text-xs font-semibold text-gray-900 mb-1.5 line-clamp-2 leading-snug hover:text-blue-600 transition-colors cursor-pointer">
                    {post.title}
                  </h3>
          ...
          <div className="bg-white rounded shadow-sm border border-gray-200 p-3 sticky top-4">
            ...
            <div className="space-y-2 max-h-[600px] overflow-y-auto">
              {latestNews.map((post) => (
                <div
                  key={post.id}
                  className="border-b border-gray-200 pb-2 last:border-0 hover:bg-gray-50 px-1 py-1.5 rounded transition-colors cursor-pointer"
                >
                  ...
                  <h3 className="text-xs font-semibold text-gray-900 line-clamp-2 leading-snug hover:text-blue-600 transition-colors cursor-pointer">
                    {post.title}
                  </h3>
                </div>
              ))}
